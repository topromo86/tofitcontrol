...
// Zapis obecności ręką trenera - jedno miejsce dla obu dróg: kliknięcia na żywo
// i zapisu dopisanego z kolejki offline po powrocie sieci.
//
// Obecność odbita kodem zajęć idzie osobną drogą (lib/services/class-qr.ts),
// bo tam o wszystkim decyduje zeskanowany kod, a nie lista przed trenerem.
//
